...
class Model:
  ...
  # Compile loss, optimizer and accuracy
  def compile(self, *, loss=None, optimizer=None, accuracy=None):# (*) -> explicitly use parameter names ('loss=' etc.)
  ...
  def train(self, X, y, *, epochs=1, batch_size=None, print_every=1, validation_data=None):
    ...
    # Initialize accuracy with true labels (see def compile() method above)
